...
<body>
    ...
    <form action="/ordered/confirm" method="POST">
        <table>
            <tr>
                <th>ID</th>
                <th>Наименование</th>
            ...
            <c:forEach var="things" items="${basketMap}">
                <c:set var="total"
                       value="${total + things.key.price * things.value}"></c:set>
                <tr>
                    <td>${things.key.id} </td>
                    <td><input type="text" name="things" value="${things.key.name}" readonly></td>
                    <td><input type="text" name="price" value="${things.key.price}" readonly></td>
                    <td><input type="text" name="value" value="${things.value}" readonly></td>
                    <td>${things.key.price * things.value}</td>
                </tr>
            </c:forEach>
            <tr>
        ...
        <table>
            ...
            <tr>
                <td>Адрес</td>
                <td><input type="text" name="delivery" value="${buyer.delivery}" readonly></td>
            </tr>
        </table>
